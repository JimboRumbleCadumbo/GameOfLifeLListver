...
Node* Node::inheritNeighbors(Node* old, bool alive) {
...
//TODO: Unhardcord paramaters
bool Node::reviveEligibility() {
  if (getNumberOfNeighbors() == 3) {this->isAlive = true; return this->isAlive; }
}
